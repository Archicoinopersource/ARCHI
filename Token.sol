...
/*
 * ArchiCoin Token Smart Contract.  
 * Author: ArchiCoin <info@archicoin.tech>
 */
 ...
 * ArchiCoin token smart contract.
 */
contract ArchiToken is AbstractToken {
  /**
  ...
  /**
   * Create new ArchiCoin token smart contract, with given number of tokens issued
   ...
   */
  function ArchiToken (uint256 _tokenCount) public {
    owner = msg.sender;
